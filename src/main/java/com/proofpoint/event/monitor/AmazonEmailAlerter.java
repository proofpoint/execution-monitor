...
public class AmazonEmailAlerter implements Alerter
{
    ...
    @Inject
    public AmazonEmailAlerter(AmazonEmailAlerterConfig config, AmazonSimpleEmailService emailService)
    {
    ...
    public void failed(Monitor monitor, String description)
    {
        try {
            ...
            log.info("Sent failed alert for monitor %s", monitor.getName());
        }
        catch (Exception e) {
    ...
    public void recovered(Monitor monitor, String description)
    {
        try {
            ...
            log.info("Sent recovery notice for monitor %s", monitor.getName());
        }
        catch (Exception e) {
